...
export const OthersBlocksOverlay = memo(({ map, othersBlocks, blockSize = BLOCK_SIZE_DEGREES }: OthersBlocksOverlayProps) => {
    return (
        <>
...
OthersBlocksOverlay.displayName = "OthersBlocksOverlay";
